const url = "../tp2new/includes/api/auth-api/auth.php";
  ...
  if (isValid.length == 2) {
    ...
    fetch(url, requestOptions)
      ...
      .then(result => {
        ...
        return alert("Verifique sus credenciales de ingreso");
      })
      .catch(error => {
...
function navegarAlHome() {
  window.location.href = "http://localhost/tp2new/inicio/inicio.php";
}
