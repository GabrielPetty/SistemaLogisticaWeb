...
<body translate="no">
  ...
  <div class="contenedorSection">
    ...
    <div class="principal">
      ...
      <img src="/tp2new/images/paginaPrincipal.jpg" class="foto" alt="pagina_de_fondo">
      ...
      <div class="saludo">
        ...
        <div>
          ...
          <a href="/tp2new/historia/index.html" style="color: white; text-decoration: none;"><i
          ...
          <hr style="size: 6px; color: white" />
          <a style="color: white; text-decoration: none;" href="/tp2new/contacto/"><i class="fa-solid fa-envelope"></i>
            <h2>Contacto</h2>
          </a>
